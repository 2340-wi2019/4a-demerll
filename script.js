$(document).ready(function() { 
    ...
    var myFavoriteThings = [];
        myFavoriteThings.push("Photography");   
        myFavoriteThings.push("Graphic Design"); 
        myFavoriteThings.push("Fashion"); 
    ...
    while ( i < myFavoriteThings.length) {
        $("#loop-output").append(myFavoriteThings[i] + "");
        i++;
    }
    //...and this comment
    ...
    //the myFavoriteThings array between this comment...
       $.each(myFavoriteThings, function(index) {
           $("#each-output").append(myFavoriteThings[index] + "");
